...
<div class="container-fluid">
    <form id="adForm" class="form-horizontal">
        <div class="row">
            <div class="col-xs-2">参数组：</div>
            <div class="col-xs-4">
                <input type="text" class="form-control" name="parameterId">
            </div>
        </div>
        <div class="row">
            <div class="col-xs-2">绑定分类：</div>
            <div class="col-xs-4">
                <input type="text" class="form-control" name="type">
            </div>
        </div>
        <div class="row">
            <div class="col-xs-2">参数名称：</div>
            <div class="col-xs-4">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
            <input type="text" class="form-control date" name="createTime">
        </div>
        </div>
