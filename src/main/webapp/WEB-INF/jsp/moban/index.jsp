...
<script type="text/javascript" src="moban/js/index.js"></script>
<script src="script/global.js" type="text/javascript"></script>
<script src="script/head.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="moban/css/main.css"/>
<link rel="stylesheet" type="text/css" href="moban/css/basic.css">
<link rel="stylesheet" type="text/css" href="moban/css/style.css" />
<link rel="stylesheet" href="moban/style/base.css" />
<link rel="stylesheet" href="moban/style/head.css" />
...
<div class="top1">
<div class="top1_main"><span class="dl">您好，欢迎光临本亲生活网！<a href="denglu"> [请登录]</a>  <a href="zhuce">[免费注册]</a></span><span class="yh_zx"><a href="hyzx">用户中心</a>  |  <a href="ddtj">我的订单</a>  |  <a href="#">帮助中心</a>  |  <a href="#">联系方式</a></span></div>
</div>


<div class="top_logo">

<div class="logo"><a href="#"><img src="moban/images/logo.jpg" width="338" height="113" / alt="本亲生活的logo标志"></a></div>
<div class="top_you">
...
<div class="headNav">
  <div class="navCon w1020">
    ...
    <div class="navCon-menu fl">
      <ul>
        <li><a class="curMenu" href="index">商城首页</a></li>
        <li><a href="tplist.html">特色产品</a></li>
        <li><a href="tplist.html">VIP专区</a></li>
        <li><a href="#">服务支持</a></li>
        <li><a href="newslist">相关资讯</a></li>
...
<div class="mainbanner">
	<div class="mainbanner_window">
		<ul id="slideContainer">
			<li><a href="#"><img src="moban/images/1.jpg" width="1920" height="500"  /></a></li>
			<li><a href="#"><img src="moban/images/2.jpg" width="1920" height="500"  /></a></li>
			<li><a href="#"><img src="moban/images/3.jpg" width="1920" height="500"  /></a></li>
			<li><a href="#"><img src="moban/images/4.jpg" width="1920" height="500" /></a></li>
		</ul>
	</div>
...
<div class="remai1">
<div class="remai1_1"><a href="cpxq.html"><img src="moban/images/remai1.jpg" width="164" height="181" /></a></div>
<div class="renai1_2"><a href="#">幼儿奶粉系列</a></div>
...
<div class="remai1">
<div class="remai1_1"><a href="#"><img src="moban/images/remai1.jpg" width="164" height="181" /></a></div>
<div class="renai1_2"><a href="#">幼儿奶粉系列</a></div>
<div class="renai1_3">本亲价：¥138.0</div>
</div>
                ...
                success:function (data) {
                    ...
                    for(var i=0;i<data.length;i++){
                        str+="\n" +
                            "<div class=\"remai1\">\n" +
                            "    <div class=\"remai1_1\"><a href=\"#\"><img src=\"moban/images/remai1.jpg\" width=\"164\" height=\"181\" /></a></div>\n" +
                            "    <div class=\"renai1_2\"><a href=\"#\">"+data[i].adName+"</a></div>\n" +
                            "    <div class=\"renai1_3\">"+data[i].price+"元</div>\n" +
                            "</div>"
                    }
                  $("#con_one_1").html(str)
                }
                ...
                success:function (data) {
                    ...
                    for(var i=0;i<data.length;i++){
                        kkk+="\n" +
                            ...
                            "    <div class=\"renai1_2\"><a href=\"#\">"+data[i].adName+"</a></div>\n" +
                            "    <div class=\"renai1_3\">"+data[i].price+"元</div>\n" +
                            "    <div class=\"renai1_2\"><a href=\"javascript:dianji("+data[i].id+")\">点击添加购物车</a></div>\n" +
                            "</div>"
                    }
                  $("#con_one_2").html(kkk)
                }
...
<div class="remai1">
<div class="remai1_1"><a href="#"><img src="moban/images/cuxiao2.jpg" width="164" height="181" /></a></div>
...
<div class="renai1_3">本亲价：¥138.0</div>
    ...
    <script>queryAdministration2</script>
...
<div class="remai1">
<div class="remai1_1"><a href="#"><img src="moban/cuxiao2.jpgimages/xinpin3.jpg" width="164" height="181" /></a></div>
<div class="renai1_2"><a href="#">手撕牛肉</a></div>
<div class="renai1_3">本亲价：¥138.0</div>
</div>


<div class="remai1">
<div class="remai1_1"><a href="#"><img src="moban/images/xinpin3.jpg" width="164" height="181" /></a></div>
<div class="renai1_2"><a href="#">手撕牛肉</a></div>
<div class="renai1_3">本亲价：¥138.0</div>
</div>
...
<div class="remai1">
<div class="remai1_1"><a href="#"><img src="moban/images/jinpin4.jpg" width="164" height="181" /></a></div>
<div class="renai1_2"><a href="#">婴儿护肤湿巾</a></div>
<div class="renai1_3">本亲价：¥138.0</div>
</div>
...
<div class="jfdh1">
<div class="jflp2"><a href="#"><img src="moban/images/jifen_1.jpg" width="66" height="66" /></a></div>
<div class="jflp3">
紫糯米粽<br />
所需积分：300分<br />
<a href="#">查看详情</a>
...
<div class="con_dmbt"><span class="dt2_1"><img src="moban/images/dm1.jpg" width="45" height="29" /></span><span class="dt2_2">大米</span>
<span class="dt2_3"> <a href="tplist.html">更多商品>></a></span>
</div>
...
<div class="con2_zc">
    ...
    <div id="wrap2">
		...
		<ul>
			<li>    	
			<h2 style="display:none"><span class="sz"><img src="moban/images/yi.jpg" width="20" height="22" /></span><span class="szmc">加拿大北极海参2000g/袋</span></h2>
            <a href="http://www.zhuotop.com">
            <div class="movielist" style="display:block">
            <img src="moban/images/dy2.jpg" />
            <dl>
            <dt>粤海商品金枪鱼粤海商品</dt>	
			...
			<li>
				<h2><span class="sz"><img src="moban/images/er.jpg" width="20" height="22" /></span><span class="szmc">加拿大北极海参2000g/袋</span></h2>
            <a href="http://www.zhuotop.com">
            <div class="movielist" >
            <img src="moban/images/dy2.jpg" />
            <dl>
			...
			<li>
			<h2><span class="sz"><img src="moban/images/san.jpg" width="20" height="22" /></span><span class="szmc">加拿大北极海参2000g/袋</span></h2>
            <a href="http://www.zhuotop.com">
            <div class="movielist" >
            <img src="moban/images/dy2.jpg" />
            <dl>
			...
			<li>
			<h2><span class="sz"><img src="moban/images/si.jpg" width="20" height="22" /></span><span class="szmc">加拿大北极海参2000g/袋</span></h2>
            <a href="http://www.zhuotop.com">
            <div class="movielist" >
            <img src="moban/images/dy2.jpg" />
            <dl>
        ...
        <div class="dmgg"><a href="#"><img src="moban/images/dmgg.jpg" width="230" height="83" /></a></div>
...
<script type="text/javascript" src="moban/,,js/jq.js"></script>
...
<div class="hdpic">
  <dl> 
    ...
    <dd> <a href="cpxq.html" target="_blank"> <img src="moban/images/dm1_1.jpg" / width="184" height="278">
      <div class="pictitle">
<div class="zz">
      ...
      <div class="picshine"></div>
        ...
        <dd> <a href="#" target="_blank"> <img src="moban/images/dm1_4.jpg" / width="184" height="278">
      <div class="pictitle">
<div class="zz">
      20枚萧亚轩明星美女高清壁枚萧亚美女高清壁枚萧轩明星美女高清壁纸图片纸图片<br />
      <span style="color:#F00; font-size:18px;">本亲价：¥138.0</span>
      ...
      <dd> <a href="#" target="_blank"> <img src="moban/images/dm1_2.jpg" / width="184" height="278">
      <div class="pictitle">
<div class="zz">
      20枚萧亚轩明星美女高清壁枚萧亚美女高清壁枚萧轩明星美女高清壁纸图片纸图片<br />
      <span style="color:#F00; font-size:18px;">本亲价：¥138.0</span>
    ...
    <dd> <a href="#" target="_blank"> <img src="moban/images/dm1_1.jpg" / width="184" height="278">
      <div class="pictitle">
<div class="zz">
      20枚萧亚轩明星美女高清壁枚萧亚美女高清壁枚萧轩明星美女高清壁纸图片纸图片<br />
      <span style="color:#F00; font-size:18px;">本亲价：¥138.0</span>
...
<div class="con_dmbt"><span class="dt2_1"><img src="moban/images/dm2.jpg" width="45" height="29" /></span><span class="dt2_2">肉类专区</span>
<span class="dt2_3"> <a href="#">更多商品>></a></span>
</div>


<div class="con2_rldk">
<div class="roulei_1"><a href="#"><img src="moban/images/rl1.jpg" width="232" height="328" /></a></div>

<div class="roulei_2">
<div class="rou_gg1"><a href="#"><img src="moban/images/rl2.jpg" width="380" height="126" /></a></div>
<div class="rou_gg1" style="padding-left:10px;"><a href="#"><img src="moban/images/rl3.jpg" width="380" height="126" /></a></div>
...
<div class="tpl_2">
<a href="#"><div class="tpl_2bt">深山放养  野味一族</div><div class="shen_jg">本亲价：¥138.0</div><div class="shen_dt"><img src="moban/images/rl4.jpg" width="180" height="114" /></div></a>
</div>
...
<div class="roulei_3"><a href="#"><img src="moban/images/rl6.jpg" width="149" height="333" /></a></div>
...
<div class="con_dmbt"><span class="dt2_1"><img src="moban/images/dm3.jpg" width="45" height="29" /></span><span class="dt2_2">蔬菜专区</span>
<span class="dt2_3"> <a href="#">更多商品>></a></span>
</div>
...
<div class="con_dmbt"><span class="dt2_1"><img src="moban/images/dm4.jpg" width="45" height="29" /></span><span class="dt2_2">水果专区</span>
<span class="dt2_3"> <a href="#">更多商品>></a></span>
</div>
...
<div class="con_jj">
<div class="con_jjbt"><span style="float:left;"><img src="moban/images/gsjj1.jpg" width="107" height="35" /></span><span style="float:right; line-height:35px; color:#669933;"><a href="#"> >> 查看详情</a></span></div>
<div class="con_jjtp"><img src="moban/images/gsjj2.jpg" width="349" height="111" /></div>
...
<div class="ggbj2"><img src="moban/images/gsjj3.jpg" width="421" height="292" /></div>
...
<div class="con_jj">
<div class="con_jjbt"><img src="moban/images/gsdt.jpg" width="120" height="35" /></div>
<div class="con_jjtp"><img src="moban/images/dtt.jpg" width="348" height="111" /></div>
<div class="con_jjnr">
...
<div class="banquan2"><img src="moban/images/xinr.jpg" width="589" height="51" /></div>
