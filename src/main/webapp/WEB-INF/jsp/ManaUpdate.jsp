    ...
    <form id="myFor">
        <div class="row">
            ...
            <div class="col-xs-4">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="标题">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <select class="form-control input-sm" name="classify" id="classify">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="date" class="form-control"  name="time" id="time" placeholder="请输入日期">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="radio"  name="status" id="status" value="1">是
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <textarea class="form-control" rows="3" name="info" id="info" placeholder="内容"></textarea>
            </div>
        </div>
    </form>
</div>
