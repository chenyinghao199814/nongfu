...
<div class="container-fluid">
    <form id="myForm">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="text" class="form-control" name="pagetitle" placeholder="页面标题">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="text" class="form-control" name="keyword" placeholder="页面关键词">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="text" class="form-control" name="pageinfo" placeholder="页面描述">
            </div>
        </div>
